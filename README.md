...
- Every logo gives the “s” the same interior fill as “ON” and “STREET” (white in the multicolor variants), with a stronger 8-unit black exterior stroke. The “s” is optically enlarged for reliable reading at header and favicon sizes. The former `logo-1color-bone.svg` utility master uses its matching bone fill inside the same black stroke.
